...
<c:set var="ctx" value="${pageContext.request.contextPath}"/>
	...
	<body ng-app="myApp" ng-controller="customersCtrl"> 
		...
		<script type="text/javascript" src="${ctx }/shenhai/js/firstpage/firstpagesystemInfo.js"></script>
				...
				<div class="col-sm-9">
						<div class="input-group">
							 <select id="selectError" ng-model="type" class="col-xs-10 col-sm-12" name="type"
							  ...
							  ng-options="option.value as option.name for option in typeList" required>
							 </select>
						</div>
				</div>
			</div>
