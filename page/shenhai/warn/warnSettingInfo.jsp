...
<c:set var="ctx" value="${pageContext.request.contextPath}"/>
	...
	<body ng-app="myApp" ng-controller="customersCtrl"> 
		...
		<script type="text/javascript" src="${ctx }/shenhai/js/warn/warnSettingInfo.js"></script>
	...
	<div class="col-xs-12"  id ="ppdiv">
		<form class="form-horizontal" role="form" name="myForm"  novalidate>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
						<div class="input-group">
							 <select id="selectError" ng-model="warn.wpId" class="col-xs-10 col-sm-12" name="wpId"
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
						<div class="input-group">
							 <select id="selectError" ng-model="warn.indicatorCode" class="col-xs-10 col-sm-12" name="indicatorCode"
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
							 <input type="number" id="form-field-1" ng-model="warn.warnLower"  class="col-xs-10 col-sm-5"/>
				</div>
			</div>
			<div class="space-4"></div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
							 <input type="number" id="form-field-1" ng-model="warn.warnUpper"  class="col-xs-10 col-sm-5"/>
				</div>
			</div>
			<div class="space-4"></div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
							 <input type="number" id="form-field-1" ng-model="warn.alarmLower"  class="col-xs-10 col-sm-5"/>
				</div>
			</div>
			<div class="space-4"></div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
							 <input type="number" id="form-field-1" ng-model="warn.alarmUpper"  class="col-xs-10 col-sm-5"/>
				</div>
			</div>
			<div class="space-4"></div>
