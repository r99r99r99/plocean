...
myApp.controller('customersCtrl',function($scope,$sce,$http,ngDialog,$modal,$timeout){
	...
	$http({  responseType:'json',
		 ...
		 .success(function(response){
			 $scope.u.standBeforeTime=response.standBeforeTime;
			 $scope.u.standAfterTime=response.standAfterTime;
			 $scope.u.contrastBeforeTime=response.contrastBeforeTime;
			 $scope.u.contrastAfterTime=response.contrastAfterTime;
	     });
